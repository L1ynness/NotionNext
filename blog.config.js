...
const BLOG = {
  ...
  NOTION_PAGE_ID:
      process.env.NOTION_PAGE_ID || '0d59fb351ae549009a82d4bbe8e188d6',
  ...
  GREETING_WORDS: process.env.NEXT_PUBLIC_GREETING_WORDS || '哈喽，一个怕期末挂科的lazy dog上线喽',

  CUSTOM_MENU: process.env.NEXT_PUBLIC_CUSTOM_MENU || false, // 支持Menu 类型，从3.12.0版本起，各主题将逐步支持灵活的二级菜单配置，替代了原来的Page类型，此配置是试验功能、默认关闭。

  AUTHOR: process.env.NEXT_PUBLIC_AUTHOR || 'Lynn', // 您的昵称 例如 tangly1024
  BIO: process.env.NEXT_PUBLIC_BIO || '一个怕期末挂科的lazy dog', // 作者简介
  LINK: process.env.NEXT_PUBLIC_LINK || 'https://personal-blog-kappa-five.vercel.app/', // 网站地址
